...
def text_2_short():
    ...
    num_result_sentences = Element('pyscriptsentnums').element.value or 10
    ...
    best_three_sentences = heapq.nlargest(num_result_sentences, sent2score, key=sent2score.get)

    text_output.clear()
    text_output.write(*best_three_sentences, append=True)
