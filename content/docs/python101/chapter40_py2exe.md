...
Проект py2exe раньше был основным способом создания исполняемых файлов Windows из ваших приложений Python. На [PyPI](https://pypi.python.org/pypi/py2exe/) есит версия, которая будет работать и с Python 2 и 3.
